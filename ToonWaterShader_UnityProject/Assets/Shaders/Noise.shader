Shader "Unlit/Noise"
{
    Properties
    {
        ...
        _NoiseCutoffStart("Noise Cutoff Start", Range(0, 1)) = 0.4
		_NoiseCutoffStop("Noise Cutoff Stop", Range(0, 1)) = 0.8
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float combinedSurfaceNoise = surfaceNoise1 + surfaceNoise2; 
